  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full relative">
      <div className="flex flex-col items-center justify-center flex-1 w-full">
        <h2 className="text-xl font-bold mb-4 text-blue-700">Welcome, insert Company code</h2>
        <input
          type="text"
          value={code}
          onChange={e => setCode(e.target.value)}
          placeholder="Company code"
          className="text-black border border-blue-300 rounded px-4 py-2 text-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      <button
