...
export function PackageIcon({ size = 64, className = "flex-shrink-0" }: PackageIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" className={className}>
      ...
      <g fill="none">
        ...
        <path
          fill="#ffce7c"
          d="m15.856 16.246l11.36-6.9a.328.328 0 0 1 .496.282v12.34a1.733 1.733 0 0 1-.83 1.48l-10.64 6.46a.272.272 0 0 1-.087.03a.268.268 0 0 1-.083.011a.895.895 0 0 1-.682-.083h.006L13 19z"
        />
        <path
          fill="#e19747"
